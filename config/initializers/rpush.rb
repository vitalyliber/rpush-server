...
Rpush.reflect do |on|
  ...
  on.apns_feedback do |feedback|
    # this code run every 60 seconds
    # see an explanation here https://github.com/rpush/rpush/issues/216
    MobileDevice.find_by(device_type: :ios, device_token: feedback.device_token).delete
  end
